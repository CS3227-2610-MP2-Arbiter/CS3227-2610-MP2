...
**Status:** Initial models/interfaces implemented, awaiting human review; accepted detection, lifecycle, provenance, count-only allocation, forward-only submission, fixed-assignment and money-removal follow-ups remain unimplemented. The issue is co-owned by zheng-jj and Whimsyturtle; this plan records accepted scope alongside the remaining model cleanup.
