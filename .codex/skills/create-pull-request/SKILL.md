...
3. Prepare the complete description before publishing. Commit, push and create or update the pull request only within the user's authorization. If publication is not authorized or available, return the prepared text and exact remaining steps.
