...
See [User Flows](UserFlows.md) for the vocabulary, the shape of both flows and the rules they share; the step-by-step behaviour is in the GitHub issues it links to.
